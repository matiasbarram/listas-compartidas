...
import { CloseBtn } from "@/components/common/Modals/closeBtn"
...
function CreateGroupForm({
    ...
    return (
        <form onSubmit={handleFormSubmit}>
            ...
            <button
                type="submit"
                className="mt-8 w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
            ...
            <div className="inline-block w-full max-w-md p-6 my-8 text-left align-middle transition-all transform bg-zinc-800 shadow-xl rounded-2xl relative">
                ...
                <div className="mt-2">
                    <p className="text-sm text-gray-500">
                        En un grupo podrás crear y compartir listas con tus
                        amigos.
                    </p>
                </div>
                <CreateGroupForm
