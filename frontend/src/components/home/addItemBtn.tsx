...
function isIListKeys(params: IListKeysProps | PageProps): {
    value: boolean
    formType: "item" | "list"
} {
        ...
        <>
            {btnType === "static" ? (
                ...
                <button
                    id="add-item-btn"
                    onClick={() => setShowModal(true)}
                    className={`fixed bottom-10 right-4 bg-indigo-800 rounded-md p-4 hover:bg-indigo-700 cursor-pointer ${
                        showBtn ? styles.show : styles.hide
                    }`}
                >
