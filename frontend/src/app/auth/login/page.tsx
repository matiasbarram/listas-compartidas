...
const ForgotPassword = () => {
    return (
        <div className="flex items-center justify-between">
            <Link href="#" className="text-sm font-medium hover:underline text-primary-500">
            ...
            <div className="w-full  rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 border-zinc-700 bg-zinc-800">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <p className="text-sm font-light text-gray-400">
                        ...
                        <Link href="/auth/register" className="font-medium hover:underline text-primary-500">
                            Regístrate
                        </Link>
                    </p>
                </div>
