...
export const GPTContext = `You will be provided with a message in natural language, and your task is to parse the message using a json. The json schema is ${JSON.stringify(
    responseSchema,
)}.
