...
import { changeStatus, createItem, deleteItem, getItems, editItem, createItems } from "../../controllers/private/items";
...
privateRouter.route('/groups/:groupId/createItems').post([checkJwt], createItems)
